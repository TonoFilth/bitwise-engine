...
#   define BW_PLATFORM_BYTEORDER BW_PLATFORM_LE
#else
#   define BW_PLATFORM_BYTEORDER BW_PLATFORM_BE
#endif
...
#       define BW_PLATFORM_IOS
#   elif TARGET_OS_MAC
#       define BW_PLATFORM_MACOS
#   else
#       error "Bw: This Apple system is not supported"
#   endif
// -----------------------------------------------------------------------------
#elif defined(_WIN32) //                                                 Windows
#   define BW_PLATFORM_WINDOWS
#   if !defined(NOMINMAX)
#       define NOMINMAX
#   endif
...
#   define BW_PLATFORM_ANDROID
// -----------------------------------------------------------------------------
#elif defined(__EMSCRIPTEN__) //                                      Emscripten
#   define BW_PLATFORM_WEB
// -----------------------------------------------------------------------------
#elif defined(__linux__) //                                                Linux
#   define BW_PLATFORM_LINUX
// -----------------------------------------------------------------------------
#elif defined(__unix__) //                                               FreeBSD
#   include <sys/param.h>
#   if defined(BSD) && defined(__FreeBSD__)
#       define BW_PLATFORM_FREE_BSD
#   else
